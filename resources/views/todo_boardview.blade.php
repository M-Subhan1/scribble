<x-dashboard-layout current-page="list">
    <div class="container dashboard-container">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary create_bdentry btn-sm">Add Column</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light border-bottom pb-0">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" id="list_id" value="{{ $list->id }}"
        ...
        <div class="px-4 mr-2 board-container">
            @foreach ($list->list_columns as $column)
                <div class="board-column">
                    <h5 class="text-muted meta-data">{{ $column->name }}</h5>
