                    ...
                    <div class="modal-body">
                        <form id="add_entry">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4 pt-1 pb-1" id="edit_content" name="name"
                                    placeholder="Your task">
                            </div>
                            <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class='text-center'>
                                    <button type="button" value="{{ $entry->id }}"
                                        class="btn btn-sm btn-primary edit-journal-btn edit_entry">Edit</button>
                                    <button class="btn btn-sm btn-danger delete-journal-btn delete_entry"
