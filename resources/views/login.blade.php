          ...
          <div class="col-12 col-md-7 col-lg-8 ms-auto">
            <div class="ps-md-10 ps-lg-36 pt-16 pb-14 pb-md-36">
              <div class="d-flex flex-column flex-sm-row mb-6 justify-content-end align-items-end align-items-sm-center">
                <span class="small text-secondary-dark mb-4 mb-sm-0 me-sm-4">I don't have an account</span>
                <a class="btn p-0 d-flex align-items-center text-success" href="#">
                  <a class="me-3" href="/scribble/public/register">Sign in</a>
              ...
              <a class="btn p-0 mb-8 d-flex align-items-center text-dark" href="/scribble/public/welcome">
                <svg width="14" height="11" viewbox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="form-floating mb-6">
                <input class="form-control" name="email" type="email" placeholder="support@shuffle.dev" value="">
