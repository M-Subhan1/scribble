          ...
          <div>
            <li class="nav-item">
              <a class="d-inline-block mb-10 bg-dark" href='/'>
                <img class="text-center img-fluid" style="height: 55px;" src="wrexa-assets/logos/logo-wrexa.svg" alt="Scribble Logo">
            ...
            <li class="nav-item mb-16 d-flex justify-content-center align-items-center">
              ...
              <button id="dashboard-hamburger" class="navbar-burger btn btn-light p-0 d-flex justify-content-center align-items-center rounded-circle" style="width: 40px; height: 40px;" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <li class="nav-item">
              <a class="btn p-0 mb-6 text-light" href='/dashboard/journal'>
                <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g>
                    <path d="M17 22H5C4.4 22 4 21.6 4 21V3C4 2.4 4.4 2 5 2H17C18.7 2 20 3.3 20 5V19C20 20.7 18.7 22 17 22Z" fill="#FFF"/>
                    <path d="M15 7H9V11H15V7Z" fill="#000"/>
                    <path d="M15 12H9C8.4 12 8 11.6 8 11V7C8 6.4 8.4 6 9 6H15C15.6 6 16 6.4 16 7V11C16 11.6 15.6 12 15 12ZM10 10H14V8H10V10Z" fill="#000"/>
                  </g>
                </svg>
                <span class="px-2 label text-light">
                  Journal
            ...
            <li class="nav-item">
              <a class="btn p-0 mb-6 text-light" href='/dashboard/lists'>
                <svg width="25" height="13" viewBox="0 0 20 9" fill="black" xmlns="http://www.w3.org/2000/svg"><line x1="0.75" y1="1.25" x2="19.25" y2="1.25" stroke="white" stroke-width="1.5" stroke-linecap="round"></line><line x1="0.75" y1="8.25" x2="13.25" y2="8.25" stroke="white" stroke-width="1.5" stroke-linecap="round"></line></svg>
              </a>
            </li>     
            <li class="nav-item">
