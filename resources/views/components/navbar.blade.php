<section>
  <nav class="position-relative navbar py-2 px-4 px-md-10 navbar-expand-xl navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <button class="d-xl-none navbar-burger btn btn-light p-0 d-flex justify-content-center align-items-center rounded-circle" style="width: 50px; height: 50px;" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
